...
export const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.currentPassword) {
      newErrors.currentPassword = selectedLanguage === 'hi' 
        ? 'वर्तमान पासवर्ड आवश्यक है' 
        : 'Current password is required';
    }

    if (!formData.newPassword) {
      newErrors.newPassword = selectedLanguage === 'hi' 
    ...
    if (!formData.confirmPassword) {
      newErrors.confirmPassword = selectedLanguage === 'hi' 
  ...
  const handleSave = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      if (formData.currentPassword === 'wrongpassword') {
        setErrors({
          currentPassword: selectedLanguage === 'hi' 
  ...
  const getPasswordStrength = (password: string) => {
    ...
    const strengthLabels = selectedLanguage === 'hi' 
      ...
      <DialogContent className="sm:max-w-[450px] max-h-[90vh] flex flex-col p-0 z-[60]">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="currentPassword">
                    {selectedLanguage === 'hi' ? 'वर्तमान पासवर्ड' : 'Current Password'} *
                  </Label>
                  <div className="relative">
                    <Input
                      ...
                      placeholder={selectedLanguage === 'hi' ? 'वर्तमान पासवर्ड दर्ज करें' : 'Enter current password'}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder={selectedLanguage === 'hi' ? 'नया पासवर्ड दर्ज करें' : 'Enter new password'}
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword">
                    {selectedLanguage === 'hi' ? 'पासवर्ड की पुष्टि करें' : 'Confirm Password'} *
                  </Label>
                  <div className="relative">
                    <Input
                      id="confirmPassword"
                      ...
                      placeholder={selectedLanguage === 'hi' ? 'पासवर्ड की पुष्टि करें' : 'Confirm new password'}
                  ...
                  {formData.confirmPassword && formData.newPassword === formData.confirmPassword && (
                    <p className="text-sm text-green-500 flex items-center">
                      ...
                      {selectedLanguage === 'hi' ? 'पासवर्ड मेल खाते हैं' : 'Passwords match'}
                    </p>
                  )}
                </div>
              </div>
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex-shrink-0">
          ...
          <div className="flex justify-end space-x-2">
            <Button variant="outline" onClick={handleCancel} disabled={isLoading} type="button">
