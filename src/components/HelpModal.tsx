...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  const shortcuts = [
    ...
    {
      key: "Ctrl + D",
      action: selectedLanguage === "hi" ? "ड्राइंग मोड" : "Drawing mode",
    },
    {
      key: "Ctrl + A",
      action: selectedLanguage === "hi" ? "विश्लेषण मोड" : "Analysis mode",
    },
    {
      key: "Ctrl + S",
      action: selectedLanguage === "hi" ? "सेटिंग्स खोलें" : "Open settings",
    },
    {
      key: "F1",
      action: selectedLanguage === "hi" ? "सहायता खोलें" : "Open help",
    },
  ];
