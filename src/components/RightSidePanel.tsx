          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {layerItems.map((layer) => {
                const isVisible =
                  (layersVisibility && layersVisibility[layer.id]) || false;
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {selectedLanguage === "hi"
                    ? "अंगनवाड़ी को निकटतम स्कूल से जोड़ें"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="text-xs font-medium text-gray-600 mb-2">
                {selectedLanguage === "hi"
                  ? "अंगनवाड़ी सेवा कवरेज"
                  : "Anganwadi Service Coverage"}
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-700">
                    {selectedLanguage === "hi"
                      ? "अंगनवाड़ी (कोई स्कूल नहीं)"
                      : "Anganwadi (No School Nearby)"}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className="w-5 h-0.5 border-t-2 border-dashed border-brown-600"
            ...
            <div className="space-y-2 pt-2 border-t border-gray-200">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className="w-4 h-4 rounded-full border border-gray-300"
                    style={{ backgroundColor: "#390988ff" }}
                  />
                  <span className="text-xs text-gray-700">
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className="w-4 h-4 rounded-full border border-gray-300"
                    style={{ backgroundColor: "#96595cff" }}
                  />
                  <span className="text-xs text-gray-700">
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className="w-4 h-4 rounded-full border border-gray-300"
                    style={{ backgroundColor: "#ff89e2ff" }}
                  />
                  <span className="text-xs text-gray-700">
