...
const basemapOptions: BasemapOption[] = [
  ...
  },
  {
    ...
    previewUrl:
      "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/7/64/42",
  },
  {
    id: "terrain",
    name: "Terrain",
    ...
    previewUrl:
      "https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/7/64/42",
  },
  {
    id: "hybrid",
    name: "Hybrid",
    ...
    previewUrl:
      "https://server.arcgisonline.com/ArcGIS/rest/services/Reference/World_Transportation/MapServer/tile/7/64/42",
  },
];
...
export const BasemapSwitcher: React.FC<BasemapSwitcherProps> = ({ map }) => {
  ...
  const { selectedLanguage, selectedBasemap, setSelectedBasemap } =
    useAppStore();
  ...
  const currentBasemap =
    basemapOptions.find((option) => option.id === demoSelectedBasemap) ||
    basemapOptions[0];
            ...
            <div className="grid grid-cols-2 gap-2">
              {basemapOptions.map((option) => (
                <Button
                  key={option.id}
                  variant={
                    demoSelectedBasemap === option.id ? "default" : "ghost"
                  }
                  size="sm"
